...
- [ ] behavior evidence P1だけを対象に独立refuterへ一回再監査する。
- [ ] v5をsupport／refuteする不変DecisionとPhase evidenceを残す。
- [ ] supportならRC1をarchiveして次campaignを正本化し、refuteなら新しいcorrection plan versionへ全再compileする。
