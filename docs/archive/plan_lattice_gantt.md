...
> **ADR 0151により運用上は失効。** 本書に残る`lattice todo gantt`と静的HTMLの記述は
> 当時の実装記録であり、現在の作業指示ではない。運用表示面は動的dashboardだけである。
...
**作成日:** 2026-07-18
**親裁定:** dotagentsの`docs/plan_lattice-factory-integration.md` Phase LG（オーナー裁定 2026-07-18）・親queue 23
