  ...
  try {
    ...
    if (value.state === 'uninitialized') {
      return value.project !== null && value.project.project_id === null && value.can_create_plan === true
        ...
        && value.next_action.input_schema === CREATE_INPUT_SCHEMA
        && value.next_action.schema_command === 'lattice plan create --schema --json';
    }
  ...
  if (storeState === undefined && manifestState === undefined) {
    const result = statusResult({
      ...
      next_action: {
        ...
        schema_command: 'lattice plan create --schema --json',
      },
    });
