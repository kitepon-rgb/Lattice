'use strict';
//
// Programmatic / embedded SDK entry for @kitepon/Lattice (issue #354).
//
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @kitepon/Lattice --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @kitepon/Lattice status`) to\n' +
