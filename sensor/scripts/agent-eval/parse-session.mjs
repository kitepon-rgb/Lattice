...
const explore = subCounts['mcp__lattice_sensor__lattice_sensor_explore'] || mainCounts['mcp__lattice_sensor__lattice_sensor_explore'] || 0;
...
console.log(`\nVERDICT: lattice_sensor_explore used ${explore}x | Read ${reads} | Grep/Bash ${greps}`);
