...
/**
 * Append a `[X.Y.Z]: https://github.com/kitepon-rgb/Lattice/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/kitepon-rgb/Lattice/releases/tag/v${version}`;
