 ...
 * skewing explore results. LatticeSensor now default-ignores the Android resource
...
describe('Android resource XML exclusion (#1047)', () => {
  ...
  beforeEach(async () => {
    dir = fs.mkdtempSync(path.join(os.tmpdir(), 'lattice-sensor-android-res-'));
