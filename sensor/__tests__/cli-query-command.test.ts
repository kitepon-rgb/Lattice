/**
 * `latticeSensor query` score rendering (#1045).
 *
...
describe('latticeSensor query — score rendering (#1045)', () => {
  let tempDir: string;

  beforeEach(async () => {
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'lattice-sensor-query-cmd-'));
