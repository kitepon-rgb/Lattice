 ...
 *
 * Asserts the native walker (lattice-sensor-kernel/src/dart.rs) produces the SAME
 ...
 * `npm test`. Skips when no kernel binary is staged; LATTICE_SENSOR_KERNEL_EXPECT=1
