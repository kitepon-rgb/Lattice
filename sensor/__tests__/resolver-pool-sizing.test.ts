 ...
 * cap + the LATTICE_SENSOR_RESOLVE_WORKERS override. resolvePoolSize is pure —
...
describe('ResolverPool.resolvePoolSize', () => {
  ...
  it('LATTICE_SENSOR_RESOLVE_WORKERS overrides everything: 0 disables, values clamp at 16', () => {
