...
// declared-then-assigned: under Lattice's write-detection semantics the
// assignment no longer prunes — laterAssigned STAYS a value-ref target
// (readsLater → laterAssigned references edge on both arms).
