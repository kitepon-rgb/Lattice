 ...
 *
 * Asserts the native walker (lattice-sensor-kernel/src/php.rs) produces the SAME
 ...
 * LATTICE_SENSOR_KERNEL_EXPECT=1 turns that into a failure (kernel-scaffold.test.ts).
 */
