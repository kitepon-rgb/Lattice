 ...
 *
 * Asserts the native walker (lattice-sensor-kernel/src/swift.rs) produces the SAME
 ...
 * Skips when no kernel binary is staged; LATTICE_SENSOR_KERNEL_EXPECT=1 turns
