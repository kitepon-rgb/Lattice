...
export class TreeSitterExtractor {
  ...
  // Value-reference edges (default ON; set LATTICE_SENSOR_VALUE_REFS=0 to disable; see flushValueRefs).
  ...
  private readonly valueRefsEnabled = process.env.LATTICE_SENSOR_VALUE_REFS !== '0';
   ...
   * function_ref), deduped per (reader, target). Default on (LATTICE_SENSOR_VALUE_REFS=0 disables) +
   ...
   * `lattice sensor query query_apply_record` returned nothing (issue #634). We emit
