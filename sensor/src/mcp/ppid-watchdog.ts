...
export interface SupervisionState {
   ...
   * (`LATTICE_SENSOR_HOST_PPID`), or null when unknown — e.g. the standalone bundle,
 ...
 * (`LATTICE_SENSOR_PPID_POLL_MS`). A value of `0` disables the watchdog entirely
 ...
 * (`LATTICE_SENSOR_HOST_PPID`). Returns a positive integer PID, or null when
