 ...
 *     `mcpServers.lattice/sensor` key. Same shape as Claude / Cursor.
...
class GeminiTarget implements AgentTarget {
  ...
  install(loc: Location, _opts: InstallOptions): WriteResult {
    ...
    // GEMINI.md gets the short marker-fenced LatticeSensor block (#704):
...
/**
 * Strip the marker-delimited LatticeSensor block from GEMINI.md if a prior
