 ...
 * single dotted-key table block (`[mcp_servers.lattice/sensor]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.lattice/sensor]`
 ...
 *     the full dotted key `[mcp_servers.lattice/sensor]`).
