 ...
 *
 * `alreadyConfigured` reports whether latticeSensor has already been
...
export interface InstallOptions {
   ...
   * lattice_sensor_explore context for structural prompts. `true` installs it,
...
export interface AgentTarget {
   ...
   * target. Used by `latticeSensor install --print-config <id>` and by
