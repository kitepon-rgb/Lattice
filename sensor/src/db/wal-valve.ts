...
export class WalCheckpointValve {
  ...
  constructor(
    ...
    // LATTICE_SENSOR_WAL_VALVE_DEBUG=1 surfaces valve decisions to stderr without
    ...
    this.log = process.env.LATTICE_SENSOR_WAL_VALVE_DEBUG
  ...
  start(): void {
    ...
    if (process.env.LATTICE_SENSOR_SYNTH_TIMINGS || process.env.LATTICE_SENSOR_WAL_VALVE_DEBUG) {
