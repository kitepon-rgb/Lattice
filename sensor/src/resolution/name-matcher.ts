 ...
 * `LATTICE_SENSOR_AMBIGUOUS_NAME_CEILING`.
 */
const DEFAULT_AMBIGUOUS_NAME_CEILING = 500;
function resolveAmbiguousNameCeiling(): number {
  const raw = process.env.LATTICE_SENSOR_AMBIGUOUS_NAME_CEILING;
...
const NM_PROFILE: Map<string, { n: number; ns: bigint }> | null =
  process.env.LATTICE_SENSOR_RESOLVE_PROFILE === '2' ? new Map() : null;
