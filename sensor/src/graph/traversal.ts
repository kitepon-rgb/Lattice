...
export class GraphTraverser {
  ...
  private getCallersRecursive(
    ...
    const incomingEdges = this.queries.getIncomingEdges(nodeId, ['calls', 'references', 'imports', 'instantiates', 'invokes']);
  ...
  private getCalleesRecursive(
    ...
    const outgoingEdges = this.queries.getOutgoingEdges(nodeId, ['calls', 'references', 'imports', 'instantiates', 'invokes']);
