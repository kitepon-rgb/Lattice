...
**Status: PORT COMPLETE (2026-07-20)** — walker `lattice-sensor-kernel/src/swift.rs`,
...
- **Staging plan:** vendor to `src/extraction/wasm/tree-sitter-swift.wasm`;
  ...
  why); pin `tree-sitter-swift = "=0.7.3"` in lattice-sensor-kernel/Cargo.toml
...
5. **One walker module** (suggest `lattice-sensor-kernel/src/swift.rs`), registered
