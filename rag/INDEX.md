...
- [network-bridge/network-bridge-deployment-research.md](network-bridge/network-bridge-deployment-research.md) — opt-in Mac bridgeをDocker Caddy／Cloudflare Tunnelへ復旧可能に接続する配備順序とgate（2026-07-21・公式仕様＋対象環境実測）
