<!-- 出典: https://dora.dev/capabilities/working-in-small-batches/ | 取得日: 2026-07-15 | 取得方法: MarkItDown（HTML直取得、bytes確認） | 確度: 中〜高（DORA公式、複数年研究の実務解説） -->

[![DORA](/img/dora-logo.svg)](/)
...
* search
* [Community  open\_in\_new](https://dora.community/)
...
[Download the ROI of AI-assisted Software Development report.](https://cloud.google.com/resources/content/dora-roi-of-ai-assisted-software-development)

[Capabilities](/capabilities/)

# Working in small batches [core](/research/#core-model) [AI](/ai/#explore-the-model)
...
[INVEST principle](https://wikipedia.org/wiki/INVEST_%28mnemonic%29):
...
approach, called *dark launching*, allows developers to check in code for small
...
[![](/img/cloud-logo-dark.svg)](https://cloud.google.com/)
...
[post\_linkedin](https://www.linkedin.com/company/doradotdev/)
[post\_youtube](https://www.youtube.com/%40dora-dev)
[github](https://github.com/dora-team/dora.dev)
