<!-- 出典: https://google.github.io/eng-practices/review/developer/small-cls.html | 取得日: 2026-07-15 | 取得方法: MarkItDown（公式HTML、bytes確認） | 確度: 中（Google公式実務規範、査読研究ではない） -->
...
This site is open source. [Improve this page](https://github.com/google/eng-practices/edit/master/review/developer/small-cls.md).
